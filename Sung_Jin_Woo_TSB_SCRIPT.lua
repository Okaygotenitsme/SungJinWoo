--Sung Jin Woo Equip Saitama to use
...
ToolName.Text = "Immeasurable Strength"
...
ToolName.Text = "Immeasurable Speed"
...
ToolName.Text = "Time Manipulation"
...
AnimAnim.AnimationId = "rbxassetid://18715977233"
...
local animationIdsToStop = {
    ...
    [18462088986] = true, --punch1

    [18462089757] = true, --punch2

    [18715745239] = true, --punch3

    [16552234590] = true, --punch4
...
local replacementAnimations = {
    ...
    ["10469493270"] = "rbxassetid://18462088986", --punch1

    ["10469630950"] = "rbxassetid://18462089757", --punch2

    ["10469639222"] = "rbxassetid://18715745239", --punch3

    ["10469643643"] = "rbxassetid://16552234590", --punch4

    ["17859015788"] = "rbxassetid://18716033506", --downslam finisher
...
-- Messages to send
local messages = {"If I Don’t Kill, I Will Be Killed. I Can’t Run Away Anymore."}
...
for _, message in ipairs(messages) do
    sendMessage(message)
    wait(2.1) -- Wait time for each message
end
